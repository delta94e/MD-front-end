...
import { NikePlatformDemo } from "./NikePlatformDemo";
import { SalesWorkflowDemo } from "./SalesWorkflowDemo";
import { StaffEngineerDemo } from "./StaffEngineerDemo";
import { OculusMetaDemo } from "./OculusMetaDemo";
import { DocusaurusAdsDemo } from "./DocusaurusAdsDemo";
import { DuoWorkflowDemo } from "./DuoWorkflowDemo";
import { GitLabVerifyDemo } from "./GitLabVerifyDemo";
import { AmazonCareDemo } from "./AmazonCareDemo";
import { DailymotionDemo } from "./DailymotionDemo";
import { CocCocDemo } from "./CocCocDemo";
import { B2CKYCDemo } from "./B2CKYCDemo";
import { ZaloB2BDemo } from "./ZaloB2BDemo";
import { BinanceDemo } from "./BinanceDemo";
import { TeraDemo } from "./TeraDemo";
import { TeraSeniorDemo } from "./TeraSeniorDemo";
import { TeraStaffDemo } from "./TeraStaffDemo";
import { PlatformEngineeringDemo } from "./PlatformEngineeringDemo";
import { ComplianceInfraDemo } from "./ComplianceInfraDemo";
import { ShopeeFinanceDemo } from "./ShopeeFinanceDemo";
import { SGFinanceLeadDemo } from "./SGFinanceLeadDemo";
import { AlibabaEcomDemo } from "./AlibabaEcomDemo";
import { SeaMoneyDemo } from "./SeaMoneyDemo";
import { CorePlatformDemo } from "./CorePlatformDemo";
import { FrontendLeadDemo } from "./FrontendLeadDemo";
import { TikTokLiveDemo } from "./TikTokLiveDemo";
import { TikTokShopDemo } from "./TikTokShopDemo";
import { EcommerceOpsDemo } from "./EcommerceOpsDemo";
import { TikTokWebPlatformDemo } from "./TikTokWebPlatformDemo";
import { ContentSafetyPlatformDemo } from "./ContentSafetyPlatformDemo";
import { SearchPlatformDemo } from "./SearchPlatformDemo";
import { AlphaTradingDemo } from "./AlphaTradingDemo";
import { AdvancedPlatformDemo } from "./AdvancedPlatformDemo";
import { SlackCoreDemo } from "./SlackCoreDemo";
import { CapitalOneDesignSystemDemo } from "./CapitalOneDesignSystemDemo";
import { SlackCanvasNavigationDemo } from "./SlackCanvasNavigationDemo";
import { SlackEnterpriseAdminDemo } from "./SlackEnterpriseAdminDemo";
import { RiotEsportsOpsDemo } from "./RiotEsportsOpsDemo";
import { EcommerceDynamicsDemo } from "./EcommerceDynamicsDemo";
import { FrameIOAdobeDemo } from "./FrameIOAdobeDemo";
import { SlackHuddlesA11yDemo } from "./SlackHuddlesA11yDemo";
import { PayPalDeveloperPlatformDemo } from "./PayPalDeveloperPlatformDemo";
import { SurveyMonkeyFederationDemo } from "./SurveyMonkeyFederationDemo";
import { SurveyMonkeyBillingDemo } from "./SurveyMonkeyBillingDemo";
import { QuoraDesignSystemDemo } from "./QuoraDesignSystemDemo";
import { SlackDxDemo } from "./SlackDxDemo";
import { SlackCanvasAiDemo } from "./SlackCanvasAiDemo";
import { CoinbaseWalletDemo } from "./CoinbaseWalletDemo";
import { InfraopsProductivityDemo } from "./InfraopsProductivityDemo";
import { ListingsMfeDemo } from "./ListingsMfeDemo";
import { AplusEditorDemo } from "./AplusEditorDemo";
import { AmazonRiskPlatformDemo } from "./AmazonRiskPlatformDemo";
import { AftA11yDemo } from "./AftA11yDemo";
...
type TabKey = "demo" | "architecture" | "state" | "eventbus" | "warstories" | "events" | "modernization" | "e2e-encryption" | "arch-review" | "offline-sticker" | "a11y-calendar" | "skip-link" | "col-config" | "org-chart" | "storybook" | "cal-talks" | "a11y-training" | "llm-observability" | "case-mgmt" | "core-product" | "eng-practices" | "experimentation" | "graphql-migration" | "ansarada-workflow" | "pathways" | "ansarada-core" | "ads-infra" | "facebook" | "build-system" | "file-browser" | "meta" | "crm" | "nike" | "sales-workflow" | "staff-eng" | "oculus" | "docusaurus-ads" | "duo-workflow" | "gitlab-verify" | "amazon-care" | "dailymotion" | "coccoc" | "b2c-kyc" | "zalo-b2b" | "binance" | "tera" | "tera-senior" | "tera-staff" | "platform-eng" | "compliance-infra" | "shopee-finance" | "sg-finance-lead" | "alibaba-ecom" | "seamoney" | "core-platform" | "frontend-lead" | "tiktok-live" | "tiktok-shop" | "ecommerce-ops" | "tiktok-web" | "content-safety" | "search-platform" | "alpha-trading" | "advanced-platform" | "slack-core" | "capital-one" | "canvas-nav" | "enterprise-admin" | "riot-esports" | "ecommerce-dynamics" | "frameio-adobe" | "huddles-a11y" | "paypal-dev" | "surveymonkey-fed" | "surveymonkey-billing" | "quora-design" | "slack-dx" | "slack-canvas-ai" | "coinbase-wallet" | "infra-devops" | "listings-mfe" | "aplus-editor" | "amazon-risk" | "aft-a11y";
    ...
    <div style={{ fontFamily: "'Inter', -apple-system, sans-serif", background: tokens.colors.background, minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: "1400px", margin: "0 auto", display: "flex", minHeight: "calc(100vh - 56px)" }}>
          ...
          {([
            ...
            },
            {
              ...
              items: [
                ...
                { key: "nike",              label: "⚫ Nike" },
                { key: "sales-workflow",    label: "⚡ Sales Workflow" },
                { key: "staff-eng",         label: "🎯 Staff Engineer" },
                { key: "oculus",            label: "🥽 Oculus / Meta" },
                { key: "docusaurus-ads",    label: "📚 Docusaurus & Ads" },
                { key: "duo-workflow",      label: "🦊 Duo Workflow" },
                { key: "gitlab-verify",     label: "🔧 GitLab Verify" },
                { key: "amazon-care",       label: "🏥 Amazon Care" },
                { key: "dailymotion",       label: "🎥 Dailymotion" },
                { key: "coccoc",            label: "🌎 Coc Coc" },
                { key: "b2c-kyc",           label: "🔐 B2C / KYC" },
                { key: "zalo-b2b",          label: "💧 Zalo B2B" },
                { key: "binance",            label: "₿ Binance Pay" },
                { key: "tera",               label: "✈ TERA SE I" },
                { key: "tera-senior",         label: "✈ TERA SE II" },
                { key: "tera-staff",           label: "✈ TERA SE III" },
                { key: "platform-eng",          label: "🔧 Platform Infra" },
                { key: "compliance-infra",        label: "⚡ Compliance & Safety" },
                { key: "shopee-finance",            label: "🏦 Shopee Finance" },
                { key: "sg-finance-lead",            label: "🇸🇬 SG Finance Lead" },
                { key: "alibaba-ecom",                label: "🛒 Alibaba / Drone" },
                { key: "seamoney",                    label: "💅 SeaMoney" },
                { key: "core-platform",               label: "⚛ React Platform" },
                { key: "frontend-lead",               label: "🚀 Frontend Lead" },
                { key: "tiktok-live",                 label: "♪ TikTok Live" },
                { key: "tiktok-shop",                 label: "🛍 TikTok Shop" },
                { key: "ecommerce-ops",               label: "🛍 Cart & Ops" },
                { key: "tiktok-web",                  label: "🔄 TikTok Web" },
                { key: "content-safety",               label: "🛡 Content Safety" },
                { key: "search-platform",               label: "🔍 Search Platform" },
                { key: "alpha-trading",                  label: "📈 Alpha Trading"    },
                { key: "advanced-platform",               label: "🏗 Adv. Platform"    },
                { key: "slack-core",                       label: "💬 Slack Core"        },
                { key: "capital-one",                       label: "🏦 Capital One DS"    },
                { key: "canvas-nav",                        label: "🖊️ Canvas & Nav"      },
                { key: "enterprise-admin",                  label: "🏢 Enterprise Admin"  },
                { key: "riot-esports",                      label: "⚔️ Riot Esports"       },
                { key: "ecommerce-dynamics",                 label: "🛍️ E-Commerce + Dynamics" },
                { key: "frameio-adobe",                      label: "🎬 Frame.io (Adobe)"      },
                { key: "huddles-a11y",                       label: "♿ Huddles A11y"         },
                { key: "paypal-dev",                          label: "💳 PayPal Dev Platform"   },
                { key: "surveymonkey-fed",                     label: "📊 SurveyMonkey Fed"      },
                { key: "surveymonkey-billing",                  label: "💳 SurveyMonkey Billing" },
                { key: "quora-design",                          label: "🎨 Quora Design System" },
                { key: "slack-dx",                              label: "💬 Slack Dev Experience" },
                { key: "slack-canvas-ai",                       label: "💬 Slack Canvas & AI" },
                { key: "coinbase-wallet",                       label: "🔵 Coinbase Wallet" },
                { key: "infra-devops",                          label: "⚙️ DevOps & InfraOps" },
                { key: "listings-mfe",                          label: "🏡 Listings & MFE" },
                { key: "aplus-editor",                          label: "📝 Amazon A+ Editor" },
                { key: "amazon-risk",                          label: "🛡️ Amazon Risk Platform" },
                { key: "aft-a11y",                             label: "📦 Amazon AFT & A11y" },
              ],
            },
        ...
        <main style={{ flex: 1, minWidth: 0, padding: "24px", overflowX: "auto" }}>
          ...
          {activeTab === "nike"              && <NikePlatformDemo />}
          {activeTab === "sales-workflow"    && <SalesWorkflowDemo />}
          {activeTab === "staff-eng"         && <StaffEngineerDemo />}
          {activeTab === "oculus"            && <OculusMetaDemo />}
          {activeTab === "docusaurus-ads"    && <DocusaurusAdsDemo />}
          {activeTab === "duo-workflow"      && <DuoWorkflowDemo />}
          {activeTab === "gitlab-verify"     && <GitLabVerifyDemo />}
          {activeTab === "amazon-care"       && <AmazonCareDemo />}
          {activeTab === "dailymotion"       && <DailymotionDemo />}
          {activeTab === "coccoc"            && <CocCocDemo />}
          {activeTab === "b2c-kyc"           && <B2CKYCDemo />}
          {activeTab === "zalo-b2b"          && <ZaloB2BDemo />}
          {activeTab === "binance"            && <BinanceDemo />}
          {activeTab === "tera"               && <TeraDemo />}
          {activeTab === "tera-senior"         && <TeraSeniorDemo />}
          {activeTab === "tera-staff"           && <TeraStaffDemo />}
          {activeTab === "platform-eng"          && <PlatformEngineeringDemo />}
          {activeTab === "compliance-infra"        && <ComplianceInfraDemo />}
          {activeTab === "shopee-finance"            && <ShopeeFinanceDemo />}
          {activeTab === "sg-finance-lead"            && <SGFinanceLeadDemo />}
          {activeTab === "alibaba-ecom"                && <AlibabaEcomDemo />}
          {activeTab === "seamoney"                    && <SeaMoneyDemo />}
          {activeTab === "core-platform"               && <CorePlatformDemo />}
          {activeTab === "frontend-lead"               && <FrontendLeadDemo />}
          {activeTab === "tiktok-live"                 && <TikTokLiveDemo />}
          {activeTab === "tiktok-shop"                 && <TikTokShopDemo />}
          {activeTab === "ecommerce-ops"               && <EcommerceOpsDemo />}
          {activeTab === "tiktok-web"                  && <TikTokWebPlatformDemo />}
          {activeTab === "content-safety"               && <ContentSafetyPlatformDemo />}
          {activeTab === "search-platform"               && <SearchPlatformDemo />}
          {activeTab === "alpha-trading"                  && <AlphaTradingDemo />}
          {activeTab === "advanced-platform"               && <AdvancedPlatformDemo />}
          {activeTab === "slack-core"                       && <SlackCoreDemo />}
          {activeTab === "capital-one"                       && <CapitalOneDesignSystemDemo />}
          {activeTab === "canvas-nav"                        && <SlackCanvasNavigationDemo />}
          {activeTab === "enterprise-admin"                  && <SlackEnterpriseAdminDemo />}
          {activeTab === "riot-esports"                      && <RiotEsportsOpsDemo />}
          {activeTab === "ecommerce-dynamics"                 && <EcommerceDynamicsDemo />}
          {activeTab === "frameio-adobe"                      && <FrameIOAdobeDemo />}
          {activeTab === "huddles-a11y"                       && <SlackHuddlesA11yDemo />}
          {activeTab === "paypal-dev"                          && <PayPalDeveloperPlatformDemo />}
          {activeTab === "surveymonkey-fed"                     && <SurveyMonkeyFederationDemo />}
          {activeTab === "surveymonkey-billing"                  && <SurveyMonkeyBillingDemo />}
          {activeTab === "quora-design"                          && <QuoraDesignSystemDemo />}
          {activeTab === "slack-dx"                              && <SlackDxDemo />}
          {activeTab === "slack-canvas-ai"                       && <SlackCanvasAiDemo />}
          {activeTab === "coinbase-wallet"                       && <CoinbaseWalletDemo />}
          {activeTab === "infra-devops"                          && <InfraopsProductivityDemo />}
          {activeTab === "listings-mfe"                          && <ListingsMfeDemo />}
          {activeTab === "aplus-editor"                          && <AplusEditorDemo />}
          {activeTab === "amazon-risk"                          && <AmazonRiskPlatformDemo />}
          {activeTab === "aft-a11y"                             && <AftA11yDemo />}
        </main>
      </div>
    </div>
  );
